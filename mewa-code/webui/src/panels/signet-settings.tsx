import type { SignetStatus } from "@mewa-code/contracts";
...
export function SignetSettings() {
	...
	return (
		<div className="mx-auto flex max-w-xl flex-col gap-lg">
			<div>
				<h2 className="tr-title-entity text-text-default">Signet memory</h2>
				<p className="mt-xs tr-text-ui text-text-muted">
					Optional durable memory for Pi sessions. All other Mewa integrations are fixed and always
					available.
				</p>
			</div>
			...
			<div className="grid grid-cols-[1fr_8rem] gap-sm">
