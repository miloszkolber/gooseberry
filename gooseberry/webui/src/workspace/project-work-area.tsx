...
import { SessionLifecycleMenu } from "../chat/session-lifecycle-controls";
import { ErrorBoundary } from "../components/error-boundary";
import { errorText, getTransport } from "../connection";
import { ChangesPanel } from "../files/changes-panel";
...
const loadDiffPane = () => import("../files/diff-pane");
const loadFilePane = () => import("../files/file-pane");
