...
export const GOOSEBERRY_SHIKI_THEME_NAME = "gooseberry-css-variables";

export const GOOSEBERRY_SHIKI_THEME: ThemeRegistration = {
	name: GOOSEBERRY_SHIKI_THEME_NAME,
	type: "dark",
	settings: [
		{
			settings: {
