...
import { useFold, useSelection } from "../runtime/fold-state";
import type { ChatRow, TurnDividerData } from "../runtime/rows";
import type { CompactionState } from "../runtime/types";
import { formatTokens } from "../session/session-stats-bar";
...
export function ChatTurnView({
	...
	switch (row.kind) {
		...
		case "image":
			return <AssistantImageTurn image={row.image} />;
		case "tool":
...
function AssistantImageTurn({ image }: { image: ImageContent }) {
	return (
		<div
			data-testid="chat-message"
			data-role="assistant"
