<script lang="ts">
import type { ProviderStatus, ProviderStatusReport, WireModel } from "@gooseberry/contracts";
	...
	<div class="flex items-start justify-between gap-sm">
		<div class="flex flex-col gap-xs">
			...
			<p class="text-text-muted tr-text-metadata">
				{catalog.length} available · {visibleCount} shown. Visibility is a Gooseberry preference.
				Goose keeps the canonical catalog.{metadataIncomplete
