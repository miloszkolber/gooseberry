...
repository=/tmp/gooseberry-git-runtime
unborn=/tmp/gooseberry-git-unborn
cleanup() {
...
root_git() {
	env -i \
		...
		GIT_AUTHOR_NAME=Gooseberry GIT_AUTHOR_EMAIL=gooseberry@example.invalid \
		GIT_COMMITTER_NAME=Gooseberry GIT_COMMITTER_EMAIL=gooseberry@example.invalid \
