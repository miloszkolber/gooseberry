...
func newRuntimeStatusProvider(build diagnostics.BuildInfo, requests *diagnostics.RequestCounter, projects *Projects, settings *Settings, staticDir string, agent *GooseClient, auth AuthConfig) *runtimeStatusProvider {
