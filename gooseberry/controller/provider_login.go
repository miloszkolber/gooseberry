...
func (p *ProviderLogins) Start(ctx context.Context, clientKey, providerID, kind string) (any, error) {
	...
	login := &providerLogin{id: randomID(), providerID: providerID, clientKey: clientKey, kind: kind, ctx: loginContext, cancel: cancel, inFlight: true, values: []map[string]string{}}
