...
func (deletions *SessionDeletions) save(records []sessionDeletion) error {
	...
	return persist.Write(deletions.store, "session-deletions.json", storedSessionDeletions{Version: 1, Engine: "goose", Records: records}, validateStoredSessionDeletions)
}
