...
func projectSessionModes(source *acp.SessionModeState) *SessionModeState {
...
func projectSessionMode(source acp.SessionMode) (SessionMode, bool) {
	id := string(source.Id)
...
func validPlanPriority(value string) bool {
	return value == string(acp.PlanEntryPriorityHigh) || value == string(acp.PlanEntryPriorityMedium) || value == string(acp.PlanEntryPriorityLow)
}

func validPlanStatus(value string) bool {
	return value == string(acp.PlanEntryStatusPending) || value == string(acp.PlanEntryStatusInProgress) || value == string(acp.PlanEntryStatusCompleted)
}
